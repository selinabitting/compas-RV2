...
if __name__ == '__main__':
    ...
    # from compas_rv2.singular.datastructures.mesh_quad_coarse.mesh_quad_coarse import CoarseQuadMesh
    # from compas_rv2.singular.datastructures.mesh_quad_pseudo_coarse.mesh_quad_pseudo_coarse import CoarsePseudoQuadMesh
    # from compas_rv2.singular.datastructures.mesh_quad_pseudo.mesh_quad_pseudo import PseudoQuadMesh
    # from compas_rv2.singular.algorithms.interpolation.layout import *
    # from compas.datastructures import meshes_join
    # from compas_plotters.meshplotter import MeshPlotter
    # from compas.utilities import average
    # from compas_rv2.singular.algorithms.interpolation.isomorphism import are_meshes_isomorphic
